...
func main() {
	...
	// IA Service (public recommendations)
	api.Get("/ia/recommendations/:userId", proxy.ProxyToService(cfg.IAServiceURL, "/api/v1/recommendations/:userId"))
	api.Get("/ia/similar/:productId", proxy.ProxyToService(cfg.IAServiceURL, "/api/v1/similar/:productId"))
	api.Post("/ia/chat", proxy.ProxyToService(cfg.IAServiceURL, "/api/v1/chat"))
	...
	protected.Get("/orders/:id", proxy.ProxyToService(cfg.OrderServiceURL, "/api/v1/orders/:id"))
	protected.Put("/orders/:id/cancel", proxy.ProxyToService(cfg.OrderServiceURL, "/api/v1/orders/:id/cancel"))
	...
	admin.Get("/stats/", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/stats/"))
	admin.Get("/logs/", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/logs/"))
	admin.Get("/logs/stats", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/logs/stats"))
	admin.Post("/logs/activity", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/logs/activity"))
	admin.Get("/clients/", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/clients/"))
	admin.Get("/clients/emails", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/clients/emails"))
	admin.Post("/clients/broadcast", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/clients/broadcast"))
	admin.Get("/discounts", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/discounts"))
	admin.Post("/discounts", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/discounts"))
	admin.Patch("/discounts/:id/toggle", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/discounts/:id/toggle"))
	admin.Delete("/discounts/:id", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/discounts/:id"))
	admin.Post("/invoices/:id", proxy.ProxyToService(cfg.AdminServiceURL, "/api/v1/admin/invoices/:id"))
	...
	// Technician routes
	tech := api.Group("/technician")
	if authMiddleware != nil {
		tech.Use(authMiddleware.RequireAuth)
	}
